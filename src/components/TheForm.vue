<template>
  <form @submit.prevent="handleSubmit()">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <p v-if="userNameValidity === 'invalid'">Invalid user name!</p>
    </div>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-tutorials" name="interest" type="checkbox" value="interest" v-model="interest" />
        <label for="interest-tutorials">Tutorials</label>
      </div>
      <div>
        <input id="interest-nothing" name="interest" type="checkbox" value="none" v-model="interest" />
...
export default {
  ...
  data() {
    return {
      userName: '',
      userAge: null,  // automatically converts value to number from string with v-model (unless use $refs)
      referrer: 'wom', // default to 'word of mouth' in dropdown
      interest: [],
      how: null,
      confirm: false,
